...
https://github.com/IgorJu/Hotel_TestTask_MVVM.SUI - Приложение для подбора отеля и номера: парсинг 3 API, ручная верстка по макету, валидация номера телефона и почты, парсинг картинок в tabView, на MVVM архитектуре. SwiftUI
